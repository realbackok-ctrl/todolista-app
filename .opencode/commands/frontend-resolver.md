...
- @docs/2-prd.md, @docs/7-execution-plan.md, @docs/9-style-guide.md, @docs/8-wireframes.md , swagger/swagger.json 핵심문서를 분석한다.
...
- 테스트가 완료되면 실행 계획 문서의 task 번호의 완료 조건을 체크한다.
